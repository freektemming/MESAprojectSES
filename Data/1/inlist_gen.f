...
!========= new METALLICITY ===============================================
  ...
  ! gradually changes abundances ! DONT FORGET TO CHANGE KAP!
  new_Z = 2.d-3  ! 14 - 7 - 2 
  relax_initial_Y = .true.
  new_Y = 0.2508d0  !!! MW=0.266d0 LMC=0.2559d0 SMC =0.2508d0
  set_uniform_initial_composition = .true.
  initial_h1 =  0.7472d0  !!! MW: 0.720d0 LMC = 0.7371d0  SMC = 0.7472d0
  initial_he4 = 0.2508d0   !!! MW=0.266d0 LMC=0.2559d0 SMC =0.2508d0
  initial_h2 = 0.0
  initial_he3 = 0.0   
...
! set_initial_omega_div_omega_crit = .true.
 ...
 new_omega_div_omega_crit = 0.2 ! 0.6
...
&kap
      ...
      Zbase = 0.002d0  ! 14 - 7 - 2 DONT FORGET TO CHANGE THIS
/ ! end of kap namelist
